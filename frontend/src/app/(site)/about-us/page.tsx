...
async function getCommunityImages() {
  try {
    const { images } = await apiFetch<{ images: { id: number; image_url: string; caption: string | null }[] }>('/api/community-images?limit=8');
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-white px-5 py-10 sm:px-8 sm:py-14">
        <h2 className="mb-4 text-center font-display text-2xl font-bold text-[#2A1F14] sm:text-3xl">Our Story</h2>
        <div className="mx-auto mb-8 h-px w-10 bg-[#C9B49A]" />
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 grid grid-cols-4 gap-2 text-center">
                {[
                  { label: 'Chocolate\nMakers', icon: <><rect x="3" y="4" width="18" height="16" rx="2" strokeLinecap="round" strokeLinejoin="round" /><path strokeLinecap="round" strokeLinejoin="round" d="M3 10h18M3 16h18M9 4v6M15 4v6" /></> },
                  { label: 'Candle\nArtists', icon: <><path strokeLinecap="round" strokeLinejoin="round" d="M12 2c-1 1.5-2 3.2-2 4.5 0 1.1.9 2 2 2s2-.9 2-2C14 5.2 13 3.5 12 2z" /><rect x="8" y="8.5" width="8" height="11" rx="1" strokeLinecap="round" strokeLinejoin="round" /></> },
                  { label: 'Resin\nCreators', icon: <><path strokeLinecap="round" strokeLinejoin="round" d="M10 3h4" /><path strokeLinecap="round" strokeLinejoin="round" d="M10 3C9 7 6 10 6 14a6 6 0 0 0 12 0c0-4-3-7-4-11H10z" /></> },
      ...
      <section className="bg-[#F7F3EE] px-5 py-10 sm:px-8">
        <h2 className="mb-4 text-center font-display text-2xl font-bold text-[#2A1F14] sm:text-3xl">Premium Materials</h2>
        <div className="mx-auto mb-8 h-px w-10 bg-[#C9B49A]" />
        <div className="grid grid-cols-4 gap-3 text-center">
          {[
            { label: 'Food Grade\nSilicone', icon: <><circle cx="12" cy="12" r="9" /><path strokeLinecap="round" strokeLinejoin="round" d="M8 15c0-2.5 1.5-5 4-7 2.5 2 4 4.5 4 7a4 4 0 0 1-8 0z" /></> },
            { label: 'Durable & Tear\nResistant', icon: <><path strokeLinecap="round" strokeLinejoin="round" d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><path strokeLinecap="round" strokeLinejoin="round" d="m9 12 2 2 4-4" /></> },
            { label: 'Flexible\nDemolding', icon: <><path strokeLinecap="round" strokeLinejoin="round" d="M7 9c0-2.8 2.2-5 5-5s5 2.2 5 5v2H7V9z" /><path strokeLinecap="round" strokeLinejoin="round" d="M5 11h14v2a7 7 0 0 1-14 0v-2z" /></> },
            { label: 'Handmade\nQuality Check', icon: <><path strokeLinecap="round" strokeLinejoin="round" d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78Z" /></> },
          ].map(({ label, icon }) => (
      ...
      <section className="bg-white px-5 py-10 sm:px-8">
        <h2 className="mb-4 text-center font-display text-2xl font-bold text-[#2A1F14] sm:text-3xl">Why Choose OXFOX?</h2>
        <div className="mx-auto mb-8 h-px w-10 bg-[#C9B49A]" />
      ...
      {/* ── OUR PROCESS ── */}
      <section className="bg-[#F7F3EE] px-5 py-10 sm:px-8">
        <h2 className="mb-4 text-center font-display text-2xl font-bold text-[#2A1F14] sm:text-3xl">Our Process</h2>
        <div className="mx-auto mb-8 h-px w-10 bg-[#C9B49A]" />
        <div className="flex items-start justify-between">
          {[
            ...
            { num: 5, step: 'Quality\nCheck', icon: <><circle cx="11" cy="11" r="8" /><path strokeLinecap="round" strokeLinejoin="round" d="m21 21-4.35-4.35" /></> },
      ...
      {/* ── CREATED BY MAKERS — scrolling marquee ── */}
      {photos.length > 0 && (
        <section className="overflow-hidden bg-white py-10 sm:py-12">
          <h2 className="mb-6 px-5 text-center font-display text-2xl font-bold text-[#2A1F14] sm:text-3xl">
            Created by Makers, Loved by Makers{' '}
            <svg xmlns="http://www.w3.org/2000/svg" className="inline-block h-6 w-6 align-middle" viewBox="0 0 24 24" fill="#FF8FAB">
              <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
            </svg>
          </h2>
          <div style={{ overflow: 'hidden' }}>
            <div style={{ display: 'flex', gap: '10px', animation: 'oxfox-marquee 24s linear infinite', width: 'max-content' }}>
              {[...photos, ...photos].map((img, i) => (
                <div key={i} style={{ width: '210px', height: '260px', flexShrink: 0, borderRadius: '14px', overflow: 'hidden', position: 'relative' }}>
                  <SmartImage src={img.image_url} alt={img.caption ?? 'Maker creation'} fill sizes="210px" className="object-cover" />
                </div>
              ))}
            </div>
          </div>
      ...
      {/* ── STATS BAR ── */}
      <section className="grid grid-cols-3 divide-x divide-white/10 bg-[#2A1F14]">
        {[
          { value: '1000+', label: 'Happy Customers', icon: <><circle cx="9" cy="7" r="4" /><path strokeLinecap="round" strokeLinejoin="round" d="M3 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2" /><path strokeLinecap="round" strokeLinejoin="round" d="M16 3.13a4 4 0 0 1 0 7.75M21 21v-2a4 4 0 0 0-3-3.87" /></> },
          { value: 'Food Grade', label: 'Silicone', icon: <><path strokeLinecap="round" strokeLinejoin="round" d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><path strokeLinecap="round" strokeLinejoin="round" d="m9 12 2 2 4-4" /></> },
          { value: 'Made in', label: 'India 🇮🇳', icon: <path strokeLinecap="round" strokeLinejoin="round" d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78Z" /> },
