    ...
    <div className="min-h-screen bg-[#FAF8F5]">
      ...
      <div className="bg-[#2A1F14] px-4 pb-6 pt-24">
        <div className="mx-auto max-w-lg text-center">
          ...
          <h1 className="font-display text-3xl font-bold uppercase tracking-wide text-white">Your Cart</h1>
          <p className="mt-1 text-sm text-white/60">Complete your order</p>

          {/* 3 badges */}
          <div className="mt-5 flex items-center justify-center gap-4 text-[11px] text-white/70">
